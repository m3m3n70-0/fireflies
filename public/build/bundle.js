...
var app = (function () {
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div0, "class", "col-wrapper svelte-19izzrt");
    			add_location(div0, file, 7, 12, 119);
    			attr_dev(div1, "class", "col1 svelte-19izzrt");
    			add_location(div1, file, 6, 8, 88);
    			attr_dev(h1, "class", "svelte-19izzrt");
    			add_location(h1, file, 13, 16, 261);
    			add_location(p, file, 14, 16, 301);
    			attr_dev(div2, "class", "col-wrapper svelte-19izzrt");
    			add_location(div2, file, 12, 12, 219);
    			attr_dev(div3, "class", "col2 svelte-19izzrt");
    			add_location(div3, file, 11, 8, 188);
    			attr_dev(div4, "class", "contact-container svelte-19izzrt");
    			add_location(div4, file, 5, 4, 48);
    			attr_dev(section, "id", "contact");
    			attr_dev(section, "class", "svelte-19izzrt");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Starting, Arrow, Info, Cure, Contact });
    	return [];
    }
