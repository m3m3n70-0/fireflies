...
var app = (function () {
    ...
    const file$1 = "src/components/Starting.svelte";
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			div = element("div");
    			attr_dev(div, "class", "background svelte-77q35y");
    			add_location(div, file$1, 5, 4, 47);
    			attr_dev(section, "id", "start");
    			attr_dev(section, "class", "svelte-77q35y");
    ...
    function create_fragment$1(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(img, "class", "svelte-1p24dna");
    			add_location(img, file, 5, 4, 45);
    			attr_dev(div, "class", "arrow svelte-1p24dna");
    ...
    function instance($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Starting, Arrow });
    	return [];
    }
